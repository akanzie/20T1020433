...
namespace _20T1020433.BusinessLayers
{
    ...
    public static class ProductDataService
    {
        ...
        /// <returns></returns>
        public static List<Product> ListProducts(string searchValue = "", int categoryID = 0, int supplierID = 0, int sortByPrice = 0)
        {
            return productDB.List(1, 0, searchValue, categoryID, supplierID, sortByPrice).ToList();
        }
        ...
        /// <returns></returns>
        public static List<Product> ListProducts(int page, int pageSize, string searchValue, int categoryID, int supplierID, int sortByPrice, out int rowCount)
        {
